...
model=EEGNet(chunk_size=128,num_electrodes=32,F1=32,F2=64,D=4,num_classes=2)
...
plt.plot(range(1,num_epochs+1),epoch_loss,marker='o',label='Training Loss',color='blue')
plt.xlabel('Epoch')
plt.ylabel('Loss')
